...
float Sampler::vanDerCorput(unsigned int sampleIndex) {
...
float Sampler::sobol2(unsigned int sampleIndex) {
...
std::tuple<float, float> Sampler::vanDerCoruptSobol2(unsigned int sampleIndex) {
  return {
